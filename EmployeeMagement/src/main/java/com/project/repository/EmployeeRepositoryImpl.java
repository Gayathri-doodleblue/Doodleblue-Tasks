...
//
//    @Override
//    public void updateDepartmentId(Long department_id, String designation) {
//        String queryString = "UPDATE Employee e SET e.department_id = (SELECT d.department_id FROM Department_Info d WHERE d.department_id = :department_id) WHERE e.designation = :designation";
